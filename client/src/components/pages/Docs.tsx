      ...
      <div className="Home">
        <div className="Docs">
          ...
          <div className="Docs-content">
            ...
            <p>
              Ori3Dita is a web-based crease pattern software for origami
              design. The core feature, aside from being web-based, is the
              ability to draw creases with specified non-flat fold angles. This
              allows designers to create and accurately document models with
              intentional 3d structures. Additionally, Ori3Dita introduces a
              novel algorithm for computing layer ordering and detecting self
              intersection in non-flat crease patterns.
              <br />
              <br />
            ...
            <p>
              Ori3Dita uses keybinds to optimize the drawing speed for the user.
              The default keybinds are listed below--most keybinds are easily
              accessible with the left hand of a QWERTY keyboard, so that the
              user can keep their right hand on the mouse. Custom keybinds will
